            ...
            <div className="lg:space-x-5 lg:flex lg:flex-row item-center lg:-mx-4 flex flex-col-reverse text-center lg:text-left">
                <div className="lg:px-4 lg:mt-12 ">
                    ...
                    <div className="mt-6 text-gray-800 dark:text-white">
                        ...
                        <p className="mb-4">
                           Currently AWS Architect - Serverless / Developer @ <b>Mobil80 Solutions and Services Pvt Ltd.</b> And contirbutor for <b>AWS ASEAN Community</b>.
                        </p>
                        ...
                        <p className="mb-4 description">
                           Check out my <a href="https://portfolio.zachjonesnoel.com/#/">portfolio</a>.
                        </p>
                        <p>
                            <a
